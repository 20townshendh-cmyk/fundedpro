...
function renderShowcaseTradeNowPage() {
  return (
    <SiteShell>
          ...
          <section className="trade-now-topbar">
            <div className="trade-now-nav">
              ...
              <div className="trade-now-tabs">
                <span className="trade-now-tab active">ES6</span>
                <span className="trade-now-tab">NQ6</span>
              </div>
            </div>
            <div className="trade-layout-tabs">
              <span className="trade-layout-tab active">Focus</span>
              <span className="trade-layout-tab">Split ES/NQ</span>
            </div>
            <div className="trade-topbar-status">
              <span>SHOWCASE</span>
          ...
          <section className="trade-now-shell">
            <aside className="trade-ladder-panel">
              ...
              <article className="surface-card emphasis-card">
                <span className="muted-label">Showcase terminal</span>
                <strong className="metric-value">Live desk preview</strong>
                <p className="surface-copy">This is the designed Trade Now showcase state. Once you buy a live challenge, this panel will switch to your real internal demo account and live positions.</p>
            ...
            <section className="trade-main-panel">
              <article className="trade-instrument-strip">
                <div className="trade-strip-symbol">
                  <strong>ES6</strong>
                  <span>E-mini S&amp;P 500</span>
                  <small>12 max contracts</small>
                </div>
                <div className="trade-strip-metrics">
                  <div><span>Exec</span><strong>5,220.75</strong></div>
                  <div><span>Chart</span><strong>5,220.25</strong></div>
                  <div><span>Capacity</span><strong>12</strong></div>
                  <div><span>Change</span><strong className="positive">+14.25</strong></div>
                  <div><span>Position</span><strong>2</strong></div>
                </div>
              </article>

              <section className="dashboard-grid trader-summary-grid">
                <article className="surface-card metric-panel">
                  <span className="muted-label">Open P&amp;L</span>
                  <strong className="metric-value positive">{formatUsd(125)}</strong>
                </article>
                <article className="surface-card metric-panel">
                  <span className="muted-label">Daily P&amp;L</span>
                  <strong className="metric-value positive">{formatUsd(640)}</strong>
                </article>
                <article className="surface-card metric-panel">
                  <span className="muted-label">Buying power</span>
                  <strong className="metric-value">{formatUsd(97500)}</strong>
                </article>
                <article className="surface-card metric-panel">
                  <span className="muted-label">State</span>
                  <strong className="metric-value">Evaluation</strong>
                </article>
              </section>

              <section className="dashboard-detail-grid">
                <article className="surface-card emphasis-card">
                  <span className="muted-label">Positions</span>
                  <strong className="metric-value">2 open</strong>
                ...
                <article className="surface-card emphasis-card">
                  <span className="muted-label">Recent fills</span>
                  <strong className="metric-value">Showcase flow</strong>
                  <ul className="bullet-list compact-list">
                    <li>ES BUY +$420.00</li>
                    <li>NQ SELL +$690.00</li>
                    <li>CL BUY -$180.00</li>
                  </ul>
                </article>
              </section>
...
export default async function TradeNowPage({ searchParams }: TradeNowPageProps) {
  ...
  if (!hasTerminalAccess) {
    ...
    if (!userAccounts.rowCount) {
      return renderShowcaseTradeNowPage();
    }
