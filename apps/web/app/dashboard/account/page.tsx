...
function renderShowcaseAccountDetailPage(input: {
  displayName: string;
      ...
      <main className="dashboard-shell">
        <aside className="dashboard-sidebar">
          <nav className="sidebar-nav">
            ...
            {input.session?.role === "ADMIN" ? <a className="sidebar-link" href="/admin">Admin panel</a> : null}
          </nav>
          ...
          <section className="account-browser">
            <div className="account-browser-list">
              ...
              <div className="account-browser-filters">
                <span className="account-browser-filter">Showcase Account</span>
                <span className="account-browser-filter">Evaluation</span>
                <span className="account-browser-filter">Phase 1</span>
              </div>
              ...
              <div className="account-browser-cards">
                <a href="/dashboard/account" className="account-browser-card active">
                  ...
                  <p className="account-browser-meta">
                    $100,000 <span>&bull;</span> Two Step <span>&bull;</span> Practitioner
                  </p>
                  <div className="account-browser-grid">
                    <div>
                      <span>Balance</span>
                      <strong>{formatUsd(104380)}</strong>
                    </div>
                    <div>
                    ...
                    <div>
                      <span>P&amp;L</span>
                      <strong className="positive">+{formatUsd(4380)}</strong>
                    </div>
                    <div>
                      <span>Profit %</span>
              ...
              <div className="account-detail-panel">
                <div className="account-detail-top">
                  <div>
                    ...
                    <h2 className="page-title account-detail-title">#FP-20481</h2>
                    <p className="page-copy">Showcase view for {input.displayName}. This matches the premium trader workstation layout while your live account is still waiting for its first real challenge purchase.</p>
                  </div>
                  <div className="account-detail-top-actions">
                    <span className="account-browser-state active">EVALUATION</span>
                    <a className="ghost-button" href="/dashboard/trades">Open Trade Now</a>
                  </div>
                </div>
                ...
                <div className="account-detail-metrics">
                  <article className="surface-card metric-panel">
                    ...
                    <strong className="metric-value">FundedPro Internal</strong>
                  </article>
                  <article className="surface-card metric-panel">
                    <span className="muted-label">Connection</span>
                    <strong className="metric-value">Demo Desk</strong>
                  </article>
                  <article className="surface-card metric-panel">
                    <span className="muted-label">Trading login</span>
                    <strong className="metric-value">FP-20481</strong>
                  </article>
                  <article className="surface-card metric-panel">
                    <span className="muted-label">Buying power</span>
                    <strong className="metric-value">{formatUsd(100000)}</strong>
                  </article>
                </div>
                ...
                <section className="account-detail-grid wide-gap">
                  <article className="surface-card account-history-card">
                    <div className="account-history-head">
                      <strong>{formatUsd(104380)}</strong>
                      <span className="positive">Equity {formatUsd(104125)}</span>
                    </div>
                    <div className="account-history-footer">
                      <span>Start {formatUsd(100000)}</span>
                      <span>14 snapshots</span>
                      <span>Range {formatUsd(6120)}</span>
                    </div>
                  </article>
                  <article className="surface-card emphasis-card">
                    <span className="muted-label">Credentials</span>
                    <strong className="metric-value">Provision-ready</strong>
                    <p className="surface-copy">When you buy a real challenge, the live account will replace this showcase login automatically and your dashboard, billing, and Trade Now views will switch to live data.</p>
                    <div className="action-row">
                      <a className="ghost-button" href="/checkout">Buy live challenge</a>
                    </div>
                  </article>
                </section>
                ...
                <section className="account-section">
                  ...
                  <div className="account-objective-list">
                    <article className="surface-card account-objective-card">
                      <div className="account-objective-head"><strong>Minimum Trading Days</strong><span>Progress: 66.7%</span></div>
                      <p>2 of 3 trading days completed</p>
                      <div className="progress-track"><span className="progress-fill" style={{ width: "67%" }} /></div>
                    </article>
                    <article className="surface-card account-objective-card">
                      <div className="account-objective-head"><strong>Maximum Daily Loss</strong><span>Remaining: {formatUsd(2400)}</span></div>
                      <p>Maximum allowed daily loss: {formatUsd(3000)}</p>
                    ...
                    <article className="surface-card account-objective-card">
                      <div className="account-objective-head"><strong>Profit Target</strong><span>{formatUsd(4380)} of {formatUsd(9000)}</span></div>
                      <p>Track progress toward the active profit objective.</p>
                      <div className="progress-track"><span className="progress-fill" style={{ width: "48%" }} /></div>
                    </article>
                  </div>
                </section>
                  ...
                  <article className="table-card">
                    <div className="table-wrap">
                      <table className="admin-table">
                        ...
                        <tbody>
                          {[
                            ["ES", "BUY", "5214.25", "5220.75", "+420.00", "21/03/2026"],
                            ["NQ", "SELL", "18206.00", "18192.25", "+690.00", "20/03/2026"],
                            ["CL", "BUY", "77.18", "76.92", "-180.00", "19/03/2026"]
                          ].map((trade) => (
                            <tr key={`${trade[0]}-${trade[5]}`}>
                              <td>{trade[0]}</td>
                              <td>{trade[1]}</td>
                              <td>{trade[2]}</td>
                              <td>{trade[3]}</td>
                  ...
                  <article className="surface-card emphasis-card">
                    ...
                    <div className="session-table">
                      <div className="session-row">
                        <span>ES</span>
                        <strong>{formatUsd(125)}</strong>
                        <span>BUY | 2 lots</span>
                      </div>
                      <div className="session-row">
                        <span>NQ</span>
                        <strong>{formatUsd(-42)}</strong>
                        <span>SELL | 1 lot</span>
                      </div>
                    </div>
                  </article>
                </section>
...
export default async function AccountDetailPage({ searchParams }: AccountPageProps) {
  ...
  if (!accountResult.rows.length || !plan) {
    return renderShowcaseAccountDetailPage({
      displayName,
      session
    });
  }
