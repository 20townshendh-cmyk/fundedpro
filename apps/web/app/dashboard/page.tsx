...
function renderEmptyProductionDashboard(input: {
  displayName: string;
  session: Awaited<ReturnType<typeof getSession>>;
  accountSummary: { totalAccounts: string; latestLogin: string | null };
}) {
  return (
    <SiteShell>
      <TopNav />
      <main className="dashboard-shell">
        <aside className="dashboard-sidebar">
          <div className="sidebar-brand">
            <p className="eyebrow">Trader workspace</p>
            <h2 className="sidebar-title">FundedPro</h2>
            <p className="surface-copy">Your workspace is live. The next step is starting a challenge so billing, account metrics, and Trade Now all light up with real data.</p>
          </div>
          <nav className="sidebar-nav">
            <a className="sidebar-link sidebar-link-gold" href="/checkout">New Challenge</a>
            <a className="sidebar-link" href="/dashboard/trades">Trade Now</a>
        ...
        <section className="dashboard-main overview-page">
          <section className="overview-topbar">
            <div className="overview-greeting">
              <div className="overview-avatar">{input.displayName.slice(0, 1).toUpperCase()}</div>
              <div>
                <h1 className="overview-hello">Hey, {input.displayName}</h1>
                <div className="overview-meta-row">
                  <span className="overview-brand-mark">FundedPro</span>
                  <span className="overview-divider" />
                  <strong>Workspace Ready</strong>
                  <span className="overview-allocation">No active evaluation yet</span>
                </div>
              </div>
            </div>
            <div className="overview-actions">
              <a href="/checkout" className="overview-action overview-action-primary">Start Challenge</a>
              <a href="/challenges" className="overview-action">Compare Plans</a>
              <a href="/dashboard/support" className="overview-action">Support</a>
            </div>
          </section>
          ...
          <section className="overview-grid">
            <article className="overview-card overview-card-level overview-level-card">
              <div className="overview-level-copy">
                <span>Next Step</span>
                <strong>Buy your first challenge</strong>
                <div className="overview-level-stats">
                  <div>
                    <span>Accounts</span>
                    <strong>{input.accountSummary.totalAccounts}</strong>
                  </div>
                  <div>
                    <span>Latest Login</span>
                    <strong>{input.accountSummary.latestLogin ? `#${input.accountSummary.latestLogin}` : "Pending"}</strong>
                  </div>
                  <div>
                    <span>Status</span>
                    <strong>Ready</strong>
                ...
                <p className="surface-copy">Once your checkout completes, this overview will switch from onboarding to live account metrics, progress tracking, and Trade Now visibility.</p>
              </div>
              <div className="overview-level-badge">FP</div>
            </article>
            ...
            <article className="overview-card overview-card-profit overview-profit-card">
              <div className="overview-card-head">
                <strong>How It Unlocks</strong>
                <span>What appears after purchase</span>
              </div>
              <div className="overview-profit-layout">
                <div className="overview-profit-side">
                  <span>Checkout</span>
                  <strong>1</strong>
                  <small>Pick account size</small>
                </div>
                <div
                  className="overview-profit-gauge"
                  style={{
                    background: "conic-gradient(from 180deg, rgba(255,97,107,0.22) 0deg 54deg, #12c48b 54deg 180deg, transparent 180deg 360deg)"
                  }}
                >
                  <div className="overview-profit-gauge-inner">
                    <span>Progression</span>
                    <strong>Live</strong>
                    <small>Provisioning, metrics, trading</small>
                  </div>
                </div>
                <div className="overview-profit-side align-end">
                  <span>Trade</span>
                  <strong>2</strong>
                  <small>Track funded path</small>
                </div>
              </div>
            </article>
            ...
            <article className="overview-card overview-card-bias">
              <div className="overview-card-head">
                <strong>What This Desk Covers</strong>
                <span>End-to-end trader flow</span>
              </div>
              <div className="overview-bias-stage">
                <div className="overview-bias-token overview-bias-token-soft">Rules</div>
                <strong className="overview-bias-title">Billing, metrics, payouts</strong>
                <div className="overview-bias-token overview-bias-token-glow">Trade Now</div>
              </div>
              <div className="overview-bias-track">
                <span className="overview-bias-fill" style={{ width: "72%" }} />
              </div>
              <div className="overview-bias-meta">
                <strong>Provisioning</strong>
                <strong>Dashboard depth</strong>
              </div>
            </article>
            ...
            <article className="overview-card overview-card-instruments">
              ...
              <div className="overview-stacked-list">
                {[
                  { symbol: "Choose a challenge", wins: 1, losses: 0, winWidth: "100%", lossWidth: "0%" },
                  { symbol: "Complete checkout", wins: 1, losses: 0, winWidth: "100%", lossWidth: "0%" },
                  { symbol: "Open Trade Now", wins: 1, losses: 0, winWidth: "100%", lossWidth: "0%" }
                ].map((item) => (
                  <div className="overview-stacked-row" key={item.symbol}>
                    <div className="overview-stacked-head">
                      <strong>{item.symbol}</strong>
...
export default async function DashboardPage() {
  ...
  if (!activeAccount || !latestOrder) {
    return renderEmptyProductionDashboard({
      displayName,
      session,
      accountSummary
    });
