...
export default async function DashboardPage() {
  ...
  const [userResult, accountResult, orderResult, payoutResult, accountSummaryResult] = await Promise.all([
  ...
  const internalSnapshot = activeAccount ? await getInternalTradingSnapshot(activeAccount.id) : null;
